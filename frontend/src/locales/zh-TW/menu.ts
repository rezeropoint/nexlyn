export default {
  ...
  "menu.算法管理": "算法管理",
  "menu.算法管理.边缘算法": "邊緣算法",
  "menu.算法管理.边缘算法.任务管理": "任務管理",
  "menu.算法管理.边缘算法.媒体通道": "媒體通道",
  "menu.算法管理.边缘算法.系统设置": "系統設置",
  "menu.算法管理.云端算法": "雲端算法",
  "menu.算法管理.端侧算法": "端側算法",
  ...
  "menu.逻辑引擎.引擎概览": "引擎概覽",
  "menu.逻辑引擎.信息原子": "信息原子",
  "menu.逻辑引擎.逻辑图配置": "邏輯圖配置",
  "menu.逻辑引擎.逻辑图详情": "邏輯圖詳情",
  "menu.逻辑引擎.标签管理": "標籤管理",
  ...
  // 系統管理
  "menu.system": "系統管理",
  "menu.system.用户管理": "用戶管理",
  "menu.system.权限管理": "權限管理",
  "menu.system.权限管理.用户角色": "用戶角色",
  "menu.system.权限管理.角色权限": "角色權限",
  "menu.system.权限管理.权限规则": "權限規則",
  "menu.system.权限管理.权限检查": "權限檢查",
  "menu.system.租户管理": "租戶管理",
  "menu.system.标签管理": "標籤管理",
  "menu.system.组织管理": "組織管理",
