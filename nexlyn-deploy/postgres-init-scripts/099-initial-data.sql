...
('p', 'super_admin', '*', 'iot_http_receive', 'read'),
('p', 'super_admin', '*', 'iot_http_receive', 'write'),
('p', 'super_admin', '*', 'iot_http_receive', 'delete'),
...
('p', 'admin', '*', 'iot_http_receive', 'read'),
('p', 'admin', '*', 'iot_http_receive', 'write'),
('p', 'admin', '*', 'iot_http_receive', 'delete'),
