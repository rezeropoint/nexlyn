...
// 获取流程字段列表
func GetFlowFieldsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetFlowFieldsRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := platform.NewGetFlowFieldsLogic(r.Context(), svcCtx)
		resp, err := l.GetFlowFields(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
