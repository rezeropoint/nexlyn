...
// 高级搜索流程记录
func SearchJourneysHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchJourneysRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := flowjourney.NewSearchJourneysLogic(r.Context(), svcCtx)
		resp, err := l.SearchJourneys(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
