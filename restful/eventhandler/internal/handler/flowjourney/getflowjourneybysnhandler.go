...
// 根据流程编号查询
func GetFlowJourneyBySNHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetFlowJourneyBySNRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := flowjourney.NewGetFlowJourneyBySNLogic(r.Context(), svcCtx)
		resp, err := l.GetFlowJourneyBySN(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
