...
// 获取状态统计
func GetStatusStatsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetStatusStatsRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := eventstats.NewGetStatusStatsLogic(r.Context(), svcCtx)
		resp, err := l.GetStatusStats(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
