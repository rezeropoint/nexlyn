...
// 获取处理时长统计
func GetDurationStatsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetDurationStatsRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := eventstats.NewGetDurationStatsLogic(r.Context(), svcCtx)
		resp, err := l.GetDurationStats(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
