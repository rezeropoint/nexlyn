...
// 获取趋势统计
func GetTrendStatsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetTrendStatsRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := eventstats.NewGetTrendStatsLogic(r.Context(), svcCtx)
		resp, err := l.GetTrendStats(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
